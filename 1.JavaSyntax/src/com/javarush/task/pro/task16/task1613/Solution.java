...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        String dayOfWeekString = dateTime.getDayOfWeek().toString();

        if (dayOfWeekString.equals("SATURDAY")  || dayOfWeekString.equals("FRIDAY") && dateTime.getHour()
                >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR || dayOfWeekString.equals("SUNDAY") && dateTime.getHour()
                < WEEKEND_END_SUNDAY_CUT_OFF_HOUR) {
            return true;
        }
        return false;
    }
